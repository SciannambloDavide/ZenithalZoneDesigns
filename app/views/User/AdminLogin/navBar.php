     ...
     <div class="w-100 pb-lg-0 pt-lg-0 pt-4 pb-3">
         <div class="container-fluid d-flex justify-content-between align-items-center flex-wrap">
                                         ...
                                         <div class="row py-lg-5">
                                             ...
                                             <div class="col col-lg-6 mb-5 mb-sm-0">
                                                 ...
                                                 <ul class="list-unstyled">
                                                     ...
                                                     <li class="dropdown-list-item"><a class="dropdown-item dropdown-link-all" href="/Product/viewProductAll?index=1&sort=date"><?= __('View All Products') ?><?php
             ...
             <ul class="list-unstyled mb-0 d-flex align-items-center">
                 ...
                 <!-- Navbar Login-->
                 <li class="ms-1 d-none d-lg-inline-block">
                     <a class="btn btn-link px-2 text-decoration-none d-flex align-items-center" href="/User/login">
