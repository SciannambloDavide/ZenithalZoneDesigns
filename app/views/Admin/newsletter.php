                ...
                <div class="row">
                    <div class="col-md-8 offset-md-2">
                        <div class="contact-form">
                            <h2 class="mb-4"><?= __("Post On The Newsletter") ?></h2>
                            <form method="post" action="/Admin/newsletter">
                                <div class="form-group">
                                    <label for="email"><?= __("To") ?></label>
                                    <input type="text" class="form-control" id="email" value="<?= __("Everyone Subscribed to the Newsletter") ?>" readonly>
                                </div>
                                <div class="form-group">
                        ...
                        <form action="/Admin/downloadSubscribersList" method="post" style="margin-bottom: 20px;">
                            <button type="submit" class="btn btn-secondary"><?= __("Download Subscribers List") ?></button>
                        </form>
                    </div>
                </div>
            </div>
