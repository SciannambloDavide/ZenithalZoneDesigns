      ...
      <div class="container position-relative z-index-20" data-aos="fade-right" data-aos-delay="300">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item breadcrumb-light"><a href="/Product/viewProductAll?index=1"><?= __('Product') ?> </a></li>
            <li class="breadcrumb-item active breadcrumb-light" aria-current="page"><?= $data['categoryName'] ?></li>
          </ol>
        </nav>
        <h1 class="fw-bold display-1 mb-4 text-white"><?= $data['categoryName'] ?></h1>
        ...
        <div class="col-12 col-lg-9">
          ...
          <div class="mb-4 d-md-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center flex-column flex-md-row">
              ...
              <div class="dropdown ms-md-2 lh-1 p-3 bg-light w-100 mb-2 mb-md-0 w-md-auto">
                <p class="fs-xs fw-bold text-uppercase text-muted-hover p-0 m-0" role="button" data-bs-toggle="dropdown" aria-expanded="false"><?= __('Sort By') ?>:</p>
            ...
            <!-- RadioButtons-->
            <a href='/Product/Category?index=1' class='form-group d-inline-block mr-2 mb-1 form-check-bg form-check-custom'>
              ...
              function updateURL(sortValue) {
                ...
                if (params) {
                  ...
                  for (var i = 0; i < paramArray.length; i++) {
                    ...
                    if (!param.startsWith('index=') && !param.startsWith('sort=')) {
                      existingParams.push(param);
                    }
                  }
                  // Append existing parameters to the new URL
                  if (existingParams.length > 0) {
                    newURL += '&' + existingParams.join('&');
                  }
                }
          ...
          <div class="row g-4 mb-5">
            ...
            foreach ($products as $index => $product) {
              //if its under the right page number for pagination
    ...
    <div class='rating position-relative d-table'>";
          ...
          <nav class='border-top mt-5 pt-5 d-flex justify-content-between align-items-center' aria-label='Category Pagination'>
            ...
            if ($index != 1) {
              echo "
                        <ul class='pagination'>
        <li class='page-item'><a class='page-link' href='/Product/Category?id=" . $_GET['id'] . "&index=" . $previousIndex . "'><i class='ri-arrow-left-line align-bottom'></i> " .  __('Prev') . " </a></li>
    </ul>
                        ";
            } else {
              echo "
            ...
            if ($index != 1 && $index != $maxPages) {
              echo "
                            <ul class='pagination'>
        <li class='page-item  mx-1'><a class='page-link' href='/Product/Category?id=" . $_GET['id'] . "&sort=" . $_GET['sort'] . "&index=$previousIndex'>$previousIndex</a></li>
        <li class='page-item active mx-1'><a class='page-link' href='/Product/Category?id=" . $_GET['id'] . "&sort=" . $_GET['sort'] . "&index=$index'>$index</a></li>
        <li class='page-item  mx-1'><a class='page-link' href='/Product/Category?id=" . $_GET['id'] . "&sort=" . $_GET['sort'] . "&index=$nextIndex'>$nextIndex</a></li>
    </ul>
            ...
            if ($nextIndex <= $maxPages) {
              echo " <ul class='pagination'>
                    <li class='page-item'><a class='page-link' href='/Product/Category?id=" . $_GET['id'] . "&sort=" . $_GET['sort'] . "&index=" . $nextIndex . "'>" .  __('Next') . " <i class='ri-arrow-right-line align-bottom'></i></a></li>
                </ul>";
            } else {
              echo "<ul class='pagination'>
                    </ul>";
