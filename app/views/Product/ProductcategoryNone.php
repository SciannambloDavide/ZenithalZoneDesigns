...
<?php $this->view('navBar'); ?>
    ...
    <section class="mt-0 ">
        ...
        style="background-image: url(../../images/ProductViewLogo.png);">
            <div class="container position-relative z-index-20" data-aos="fade-right" data-aos-delay="300">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item breadcrumb-light"><a href="/Product/viewProductAll?index=1"><?= __('Products') ?></a></li>
                      <li class="breadcrumb-item active breadcrumb-light" aria-current="page"><?=$data['categoryName']?></li>
                    </ol>
                </nav>                <h1 class="fw-bold display-1 mb-4 text-white"><?=$data['categoryName']?></h1>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-9">
                    ...
                    <div class="mb-4 d-md-flex justify-content-between align-items-center">
                        ...
                        <h6><?= __('There is no product for this category') ?></h6>
                    </div>                    <!-- / Top Toolbar-->
