        ...
        <div id="content" class="p-4 p-md-5">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="title" id="title" placeholder="<?= __("Category Title") ?>" value='<?= $data['category']->title ?>' required>
            ...
            <div class="col-md-13">
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex">
                            <b><?= __("List of Products With") ?> <b><?= $data['category']->title ?> </b><?= __("Category") ?></b>
                            <a href="/Category/addMultiple?id=<?= $data['category']->category_id ?>"><button class="btn btn-sm btn-outline-dark" style="width: auto; height:auto; margin-right: 5px;"><i class="fa fa-plus"> <?= __("Add") ?></i></button></a>
                            <form method="GET" action="" class="input-group " id="categoryForm">
                                ...
                                <button class="btn btn-sm btn-outline-dark  ml-auto" style="width: auto; height:auto; margin-right: 5px;" onclick="setProductIds('/Category/deleteMultiple')" id="removeButton"><i class="fa fa-minus"> <?= __("Remove")?></i></button>
                            </form>
